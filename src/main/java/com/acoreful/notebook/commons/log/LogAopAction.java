package com.acoreful.notebook.commons.log;
...
import com.acoreful.notebook.entity.LogFormMap;
import com.acoreful.notebook.mapper.LogMapper;
/**
 * 切点类
 */
@Aspect
...
public  class LogAopAction {
    //本地异常日志记录对象
     ...
     //Controller层切点
    @Pointcut("@annotation(com.acoreful.notebook.commons.annotation.SystemLog)")
